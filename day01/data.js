...
// const fs = require('fs');
// const fileContent = fs.readFileSync('./data.js', 'utf-8');
// const lines = fileContent.split('\n');
// const nonEmptyLines = lines.filter(line => line.trim() !== '');
// const jsArray = `const data = ${JSON.stringify(nonEmptyLines, null, 2)};\n`;
// fs.writeFileSync('cleanData.js', jsArray);
// console.log('New JavaScript file "data.js" created with non-empty lines.');
////
